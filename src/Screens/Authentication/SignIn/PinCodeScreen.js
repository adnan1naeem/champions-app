import { Image, StyleSheet, Text, TouchableOpacity, ImageBackground, View, ScrollView, } from "react-native";
      ...
      <ScrollView>
        ...
        <View style={styles.Login_view}>
          <View style={{ flex: 1, alignSelf: 'center', paddingVertical: 20 }}>
            <Text style={{ color: 'white', fontSize: 20, fontWeight: 300 }}>33100-3217986-1</Text>
          </View>
          <View style={{ width: "78%", alignSelf: "center", marginVertical: 50 }}>
            <View>
              <Text style={{ marginTop: 20, alignSelf: 'center', fontSize: 20, color: 'white', fontWeight: '200' }}>Enter your 5 digit OTP</Text>
              <OtpInput />
            </View>
