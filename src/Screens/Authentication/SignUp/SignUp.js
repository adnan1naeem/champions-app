...
const SignUp = () => {
  ...
  const handleSignUp = () => {
    if (
      Name && cnic && mobile && Address && password && isChecked === true && dealerCode
    ) {
            ...
            >
              <View style={styles.checkbox}>
                {isChecked ? (
                  ...
                  >
                    <Ionicons name="checkmark" size={24} color={Colors.text_Color} borderColor="transparent" />
                  </LinearGradient>
                ) : (
                  <Ionicons name="checkbox-outline" size={24} color={Colors.text_Color} />
                )}
              </View>
