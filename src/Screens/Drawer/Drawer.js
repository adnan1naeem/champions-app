    ...
    return (
        ...
        >
            ...
            <View style={{ marginLeft: 20 }}>
                <Text style={{ fontSize: 16, fontWeight: '500', color: Colors.text_Color, }}>ACCOUNT SETTINGS</Text>
                <Text style={{ fontSize: 12, fontWeight: '400', color: Colors.text_Color, }}>Account,{' '}Settings,{' '}More</Text>
            </View>
            ...
            <View style={{ paddingHorizontal: 30, marginTop: 50, gap: 10 }}>
                ...
                <TouchableOpacity onPress={() => navigation.navigate('HelpFAQ')} style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                    <View style={{ flexDirection: 'row', }}>
