            ...
            <ScrollView>
                ...
                <View style={[styles.Login_view, { paddingBottom: 40 }]}>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: '4%' }}>
                        <Image source={require('../../../../Assets/Image/product1.jpeg')} style={{ height: 160, width: '48%', resizeMode: 'stretch', marginTop: 15 }} />
                        <Image source={require('../../../../Assets/Image/product1.jpeg')} style={{ height: 160, width: '48%', resizeMode: 'stretch', marginTop: 15 }} />
                    </View>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 10, paddingHorizontal: '4%' }}>
                        <Image source={require('../../../../Assets/Image/product2.jpeg')} style={{ height: 160, width: '48%', resizeMode: 'stretch' }} />
                        <Image source={require('../../../../Assets/Image/product2.jpeg')} style={{ height: 160, width: '48%', resizeMode: 'stretch' }} />
                    </View>
                </View>
            </ScrollView>
