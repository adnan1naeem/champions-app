                        ...
                        {privacy ? (
                            ...
                            <View>
                                <Text style={styles.about_text}>
                                    ...
                                    collects data from its users including the data which users provide
                                    to enroll and further use this application and the data which this
                                    app collects by itself or through any third party. The types of data
                                    collected including but not limited to first name, last name, mobile
                                    number, email address, Phone number, CNIC number, postal address
                                    etc.
                                </Text>
                                <Text style={styles.about_text}>
                                    The Personal Data may be freely provided by the User, or collected
                                    automatically when using this Application. Any use of Cookies - or
                                    of other tracking tools - by this Application or by the owners of
                                    third party services used by this Application, unless stated
                                    otherwise, serves to identify Users and remember their preferences,
                                ...
                                <Text style={styles.about_text}>
                                    ...
                                    types of persons in charge, involved with the operation of the app
                                ...
                                <Text style={styles.about_text}>
                                    ...
                                    in any other places where the parties involved with the processing
                                ...
                                <Text style={styles.about_text}>
                                    by applicable law notwithstanding this limitation, Use the app in
                                    any way prohibited by law, regulation, governmental order or decree.
                                </Text>
                                <Text style={styles.about_text}>
                                    Also the app cannot be used to defame, abuse, harass, stalk,
                                    threaten, or otherwise violate the legal rights (such as rights of
                                    privacy and publicity) of others, engage in activity that is false
                                    or misleading or that is harmful to you, others (including
                                    children), or the app (e.g., transmitting viruses, communicating
                                    hate speech, or advocating violence against others), share
                                    inappropriate content, advertising, spam, spyware or malware, gain
                                    (or attempt to gain) unauthorized access to any service, data,
                                    account or network by any means, Infringe upon the rights of others,
                                    Use the app anywhere other than the platform where the app publisher
                                    has made it available, unless the app publisher has enabled such
                                    uses, Remove, modify, or tamper with any notice or link that is
                                ...
                                <Text style={styles.about_text}>
                                    If app publisher believes that you are making unauthorized use of
                                    the app or that you are in violation of these terms, it may suspend
                                    or terminate your access to app publisher’s service with or without
                                    notice. This may result in a loss of your data.
                                </Text>
                                <Text style={styles.about_text}>
                                    You grant to app publisher the right to use any content that you
                                    submit via the app as necessary for app publisher to provide the
                                    service to you.
                                </Text>
                                <Text style={styles.about_text}>
                                    The app may be subject to international technology control or export
                                    laws and regulations. You must comply with all domestic and
                                    international export laws and regulations that apply to the
                                    technology used or supported by the app. App publisher may update
                                    these terms of use at any time by amending this page. Please check
                                    this page from time to time to take notice of any changes, as they
                                    are binding on you.
                                </Text>
                                <Text style={styles.about_text}>
                                    {' '}
                                ...
                                <Text style={styles.about_text}>
                                    ...
                                    claims), regardless of conflict of law principles. This agreement
                                ...
                                <Text style={styles.about_text}>
                                    ...
                                    warranties, guarantees, or conditions in relation to the app. To the
                                    extent permitted under your local laws, app publisher excludes any
                                ...
                                <Text style={styles.about_text}>
                                    ...
                                    special, indirect or incidental damages from the app publisher. If
                                    your local laws impose a warranty, guarantee or condition even
                                    though these terms do not, its duration is limited to 90 days from
                                    when you begin using the app. This limitation applies to anything
                                    related to the app or services made available through the app; and
                                    Claims for breach of contract, warranty, guarantee, or condition;
                                    strict liability, negligence, or other tort; violation of a statute
                                    or regulation; unjust enrichment; or under any other theory; all to
                                    the extent permitted by applicable law. This limitation applies even
                                    if this remedy doesn’t fully compensate you for any losses; or the
                                    app publisher knew or should have known about the possibility of the
                                    damages.
                                </Text>
                                <Text style={styles.about_text}>
                                    {' '}
                                ...
                                <Text style={styles.about_text}>
                                    ...
                                    Data may be requested from the Data Controller at any time. Users
                                    have the right, at any time, to know whether their Personal Data has
                                    been stored and can consult the Data Controller to learn about their
                                    contents and origin, to verify their accuracy or to ask for them to
                                    be supplemented, cancelled, updated or corrected, or for their
                                    transformation into anonymous format or to block any data held in
                                    violation of the law, as well as to oppose their treatment for any
                                    and all legitimate reasons. Requests should be sent to the Data
                                ...
                                <Text style={styles.about_text}>
                                    ...
                                    app. It is strongly recommended to check this page often, referring
                                ...
                                <Text style={styles.about_text}>
                                    ...
                                    Controller remove the Personal Data. Unless stated otherwise, the
                                    then-current privacy policy applies to all Personal Data the Data
                                    Controller has about Users.
                                </Text>
                                <Text style={styles.about_text}>
                                    The definitions and legal references of personal data means any
                                ...
                                <Text style={styles.about_text}>
                                    ...
                                    coincide with or be authorized by the Data Subject, to whom the Data
                                ...
                                <Text style={styles.about_text}>
                                    ...
                                    reached such age of majority, your parent or legal guardian must
